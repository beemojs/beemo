  ...
  describe('createProjectRefConfigsInWorkspaces()', () => {
    it('creates a source and optional test config in each package root', () => {
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/bar/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
            declarationDir: 'lib',
            outDir: 'lib',
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/baz/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
            declarationDir: 'lib',
            outDir: 'lib',
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/baz/tests/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/foo/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
            declarationDir: 'lib',
            outDir: 'lib',
    ...
    it('supports custom `srcFolder` and `buildFolder`', () => {
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/qux/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
    ...
    it('supports custom `typesFolder` and `testsFolder`', () => {
      ...
      expect(writeSpy).toHaveBeenCalledWith(
        PROJECT_REFS_FIXTURE_PATH.append('packages/foo/custom-tests/tsconfig.json'),
        driver.formatConfig({
          compilerOptions: {
            emitDeclarationOnly: false,
            noEmit: true,
