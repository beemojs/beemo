...
- **[flow-bin]** Update to latest. ([f0ad786](https://github.com/beemojs/beemo/commit/f0ad786))
...
- Update config and args types. ([ac43586](https://github.com/beemojs/beemo/commit/ac43586))

#### 📦 Dependencies

- **[flow-bin]** Update to latest. ([0e02636](https://github.com/beemojs/beemo/commit/0e02636))
