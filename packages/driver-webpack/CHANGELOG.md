...
- **[webpack]** Update to v5 latest. ([a898ccc](https://github.com/beemojs/beemo/commit/a898ccc))
...
- Update config and args types. ([be75d6f](https://github.com/beemojs/beemo/commit/be75d6f))

#### 📦 Dependencies

- **[webpack]** Update to and add support for v5. ([c3a29d1](https://github.com/beemojs/beemo/commit/c3a29d1))
