...
- Allow driver native short options to be passed. ([84b45c3](https://github.com/beemojs/beemo/commit/84b45c3))
...
- Update [@types](https://github.com/types) dependencies. ([7f8005b](https://github.com/beemojs/beemo/commit/7f8005b))
